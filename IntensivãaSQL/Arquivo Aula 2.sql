...
SELECT * FROM alugueis;  -- Total: 578 Alugueis
SELECT * FROM atores;    -- Total: 145 Atores
SELECT * FROM atuacoes;  -- Total: 213 Atuacões
SELECT * FROM clientes;  -- Total: 123 Clientes
SELECT * FROM filmes;    -- Total: 71 Filmes
...
-- b) Descubra a quantidade total de notas de filmes feitos para todo o período (utilize a coluna nota para esse cálculo).
...
-- c) Você viu alguma diferença no resultado? O que aconteceu?
		...
		-- A coluna de notas contem valores nulos que são disconsiderados.
